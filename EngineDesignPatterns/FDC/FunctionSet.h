...
// Function sets can be created dynamically 

struct TransformFuncs : Set
{
...
struct MessagingFuncs : Set
{
	void Send(std::vector<MessagingFuncs> m, Container dc)
	{
		for (auto i : m)
			i.OnReceive(dc);
	}
